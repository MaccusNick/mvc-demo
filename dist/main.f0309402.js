...
var $button1 = (0, _jquery2.default)("#add1"); // 用jQuery获取 add1 button
var $button2 = (0, _jquery2.default)("#minus1");
var $button3 = (0, _jquery2.default)("#mul2");
var $button4 = (0, _jquery2.default)("#divide2");
var $number = (0, _jquery2.default)("#number"); // 获取 number div
var n = localStorage.getItem("n"); // 把信息存入本地内存中
$number.text(n || 100); //number div 的默认值为

$button1.on("click", function () {
  var n = parseInt($number.text()); //取出number中内容，转化为数字，放入变量n
  n += 1; //每次数字加1
...
//# sourceMappingURL=/main.f0309402.map